...
if(isset($_POST["create"])){
    ...
    $sql->execute();
    $req = $oPension->db_create($_POST["lib_pension"], $_POST["date_deb_pension"], $_POST["duree_pension"], $_POST["tarif_pension"], $_POST["ref_cheval"], $_POST["ref_type_p"], $_POST["ref_per"] );
    if($req){
        ?>
            <script>
